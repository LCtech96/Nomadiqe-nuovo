...
import { Instagram, Youtube, Users, MessageCircle, Euro } from "lucide-react"
...
export default function HomePage() {
  ...
  // Default view (Traveler or no role)
  return (
    <div className="min-h-screen bg-background pb-20">
      <div className="container mx-auto p-4">
        <h1 className="text-2xl md:text-3xl font-bold mb-6">Home</h1>
        <p className="text-muted-foreground">Benvenuto su Nomadiqe!</p>
      </div>
    </div>
  )
}

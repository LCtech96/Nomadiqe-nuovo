-- ============================================
-- FIX COMPLETO DEL DATABASE - VERSIONE SEMPLIFICATA
-- ============================================
-- Questa query risolve TUTTI i problemi in modo semplice e sicuro
-- ============================================
...
-- 2. AGGIORNA IL CONSTRAINT DEL RUOLO
-- ============================================
...
-- Verifica quale colonna esiste (owner_id o host_id) e crea le policy corrette
DO $$
BEGIN
  -- Se esiste owner_id, usa quello
  ...
  -- Se esiste host_id invece, usa quello
  ELSIF EXISTS (SELECT 1 FROM information_schema.columns WHERE table_schema = 'public' AND table_name = 'properties' AND column_name = 'host_id') THEN

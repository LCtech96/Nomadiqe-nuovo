-- ============================================
-- FIX COMPLETO DEL DATABASE - VERSIONE ULTIMATIVA
-- ============================================
...
-- 3. AGGIUNGI COLONNE ALLA TABELLA PROPERTIES
-- ============================================
...
-- Aspetta un momento per assicurarsi che tutte le modifiche siano state applicate
-- Poi crea le policy
...
-- Crea policy per INSERT, UPDATE e DELETE usando la colonna owner_id
-- NOTA: La colonna owner_id ESISTE nel database (verificato)
-- Nelle policy RLS, le colonne vengono referenziate senza il nome della tabella

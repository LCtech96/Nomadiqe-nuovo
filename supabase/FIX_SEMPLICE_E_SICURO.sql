-- ============================================
-- FIX COMPLETO DEL DATABASE - VERSIONE SEMPLICE E SICURA
-- ============================================
-- Questa query risolve TUTTI i problemi in modo semplice
...
-- 3. AGGIUNGI COLONNA updated_at A PROPERTIES (PRIMA DELLE POLICY)
-- ============================================
...
-- 4. AGGIUNGI ALTRE COLONNE MANCANTI ALLA TABELLA PROPERTIES
-- ============================================
...
-- 5. CORREGGE LE POLICY RLS PER PROPERTIES (USA owner_id)
-- ============================================
...
-- Crea policy per INSERT, UPDATE e DELETE (usa owner_id che ESISTE nel database)
...
-- 6. VERIFICA E CORREGGE I DATI ESISTENTI
-- ============================================
...
-- 7. CREA/RIGENERA TRIGGER PER UPDATED_AT
-- ============================================
...
-- Trigger per properties (solo se updated_at esiste)
DO $$
BEGIN
